    ...
    <div class="col-md-6">
        <div class="card p-3 p-md-3 p-lg-5 mt-5">
            <div class="text-center">
                {{-- <img width="82px" height="82px" src="{{ asset('/storage/app/'. auth()->user()->image) }}"> --}}
                {{-- <img width="82px" height="82px" src="images/users/default.png"> --}}
                <img width="82px" height="82px" src=" 
                ...
                @else 
                 ...
                 @endif ">
                <h3 class="mt-4 font-weight-bold">{{ ucfirst(auth()->user()->name) }}</h3>
            </div>
            ...
            <div class="card-body">
                <form method="POST" action="/profile" enctype="multipart/form-data">
                    ...
                    <div class="form-group d-flex flex-row-reverse mt-5">
                        ...
                        <form action="/logout">
                            <button type="submit" class="btn btn-light mr-2 ">تسجيل الخروج</button>
                        </form>
