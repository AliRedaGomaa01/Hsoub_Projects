...
@section('content')
{{-- <div class="center-1" > --}}
<div style="width:90vw; height:80vh; display:grid; justify-content:center; align-content:center; margin: 0 auto; "  >
    <h1 class=" text-center"> مرحبا بك في تطبيق مشاريعي لمتابعة المشاريع والمهام </h1>
</div>
@endsection
