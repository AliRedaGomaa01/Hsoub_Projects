            ...
            <div class="flex">
                ...
                <div class="flex items-center grow">
                    <a href="{{ route('home_page') }}">
                        <div class="bg-gray-900 rounded-2xl py-1 px-7 w-4/6 grid justify-center">
            ...
            <div class="sm:flex sm:items-center">
                ...
                @auth
                    <div class="hidden md:flex md:flex-row space-x-3 items-center justify-center">
                        ...
                        {{-- Create Post --}}
                        {{-- <button onclick="{{Livewire.dispatch('openModal', { component: { component: { component: { component: 'create-post-modal' } } } })}}"> --}}
                        ...
                        <div class="hidden md:block">
                            ...
                            <x-dropdown  align='{{ app()->getLocale()==="ar" ? "left" : "right"}}' width="96">
                                <x-slot name="trigger">
